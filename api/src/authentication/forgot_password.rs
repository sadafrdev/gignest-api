use axum::{
    Json, Router, extract::{Extension, State}, routing::{patch, post}
};
use serde::Deserialize;
use utils::{db::DB, error::AppError};
use authentication::forgot_password::{SendOtp, UpdatePassword, UpdatePasswordResponse, VerifyOtp, VerifyOtpResponse};
